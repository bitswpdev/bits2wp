...
$realhomes_addon->add_field( 'REAL_HOMES_monthly_rental', 'Monthly Rental', 'text', null, 'Only digits, example: 1000' );

$realhomes_addon->add_field( 'REAL_HOMES_reference', 'Reference', 'text', null, 'e.g. F0852' );

$realhomes_addon->add_field( 'REAL_HOMES_bar_size', 'Bar Size', 'text', null, 'Only digits' );

$realhomes_addon->add_field( 'REAL_HOMES_terrace_size', 'Terrace Size', 'text', null, 'Only digits' );

$realhomes_addon->add_field( 'REAL_HOMES_chairs_inside', 'Chairs Inside', 'text', null, 'Only digits' );

$realhomes_addon->add_field( 'REAL_HOMES_chairs_outside', 'Chairs Outside', 'text', null, 'Only digits' );

$realhomes_addon->add_field( 'REAL_HOMES_tables_inside', 'Tables Inside', 'text', null, 'Only digits' );

$realhomes_addon->add_field( 'REAL_HOMES_tables_outside', 'Tables Outside', 'text', null, 'Only digits' );

$realhomes_addon->add_field( 'REAL_HOMES_kitchen_contents', 'Kitchen Contents', 'text', null, '' );

$realhomes_addon->add_field( 'REAL_HOMES_bar_contents', 'Bar Contents', 'text', null, '' );

$realhomes_addon->add_field( 'REAL_HOMES_heating_aircon', 'Heating / Aircon', 'text', null, '' );

$realhomes_addon->add_field( 'REAL_HOMES_terrace_tax', 'Terrace Tax', 'text', null, '' );
...
function realhomes_addon_import( $post_id, $data, $import_options, $article ) {
	...
	$fields = array(
		...
		'REAL_HOMES_reference',
		'REAL_HOMES_monthly_rental',
		'REAL_HOMES_bar_size',
		'REAL_HOMES_terrace_size',
		'REAL_HOMES_chairs_inside',
		'REAL_HOMES_chairs_outside',
		'REAL_HOMES_tables_inside',
		'REAL_HOMES_tables_outside',
		'REAL_HOMES_kitchen_contents',
		'REAL_HOMES_bar_contents',
		'REAL_HOMES_heating_aircon',
