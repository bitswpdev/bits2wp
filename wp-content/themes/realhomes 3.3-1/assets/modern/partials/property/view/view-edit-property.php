				...
				<form id="submit-property-form" class="rh_form__form" enctype="multipart/form-data" method="post">
					...
					<div class="rh_form__row">
						...
						if ( in_array( 'year-built', $inspiry_submit_fields, true ) ) {
							get_template_part( 'assets/modern/partials/property/view/form-fields/year-built' );
						}
						?>
					...
					<div class="rh_form__row">
						 ...
						 * Property Views
						 */
						if ( in_array( 'views', $inspiry_submit_fields, true ) ) {
							get_template_part( 'assets/modern/partials/property/view/form-fields/property-views' );
						}
						?>
